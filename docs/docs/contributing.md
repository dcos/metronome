...
The documentation that is published [here](https://dcos.github.io/metronome/) actually gets
...
the mark down files [here](https://github.com/dcos/metronome/tree/master/docs) and use the edit
