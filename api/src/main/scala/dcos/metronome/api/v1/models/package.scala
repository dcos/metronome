...
package object models {
  ...
  implicit lazy val DockerPullConfigFormat: Format[DockerPullConfig] = Json.format[DockerPullConfig]

  implicit lazy val ImageSpecFormat: Format[ImageSpec] = (
    (__ \ "id").format[String] ~
    (__ \ "kind").formatNullable[String].withDefault(ImageSpec.DefaultKind) ~
    (__ \ "forcePull").formatNullable[Boolean].withDefault(false) ~
    (__ \ "pullConfig").formatNullable[DockerPullConfig])(ImageSpec.apply, unlift(ImageSpec.unapply))
