...
class JobScheduleController(
  ...
  def getSchedules(id: JobId) = measuredAction {
  ...
  def getSchedule(id: JobId, scheduleId: String) = measuredAction {
    AuthorizedAction.async { implicit request =>
      jobSpecService.getJobSpec(id).map {
  ...
  def createSchedule(id: JobId) = measuredAction {
  ...
  def updateSchedule(id: JobId, scheduleId: String) = measuredAction {
  ...
  def deleteSchedule(id: JobId, scheduleId: String) = measuredAction {
    AuthorizedAction.async { implicit request =>
