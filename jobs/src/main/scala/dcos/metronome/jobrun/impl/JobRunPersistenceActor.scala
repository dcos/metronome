...
/**
  ...
  */
class JobRunPersistenceActor(id: JobRunId, repo: Repository[JobRunId, JobRun], metrics: Metrics)
  ...
  def create(jobRun: JobRun): Unit =
    createJobRunTimeMetric.blocking {
  ...
  def update(change: JobRun => JobRun): Unit =
    updateJobRunTimeMetric.blocking {
  ...
  def delete(orig: JobRun): Unit =
    deleteJobRunTimeMetric.blocking {
