...
class JobRunExecutorActor(
  ...
  def creating: Receive = {
    ...
    case msg: Any =>
      log.warning("Received unexpected message {} while creating", msg)
  }
  ...
  def starting: Receive = {
    ...
    case msg: Any =>
      log.warning("Received unexpected message {} while starting", msg)
  }
  ...
  def active: Receive = {
    ...
    case msg: Any =>
      log.warning("Received unexpected message {} while active", msg)
  }
  ...
  def finishing: Receive = {
    ...
    case msg: Any =>
      log.warning("Received unexpected message {} while finishing", msg)
  }
  ...
  def failing: Receive = {
    ...
    case msg: Any =>
      log.warning("Received unexpected message {} while failing", msg)
  }
  ...
  def aborting: Receive = {
    ...
    case msg: Any => log.warning("Cannot handle {}, executor aborting.", msg)
  }
...
object JobRunExecutorActor {
  ...
  def props(
    ...
    new JobRunExecutorActor(run, promise, persistenceActorRefFactory, launchQueue, driverHolder, clock)
  )
}
