...
class SchedulerModule(
  ...
  lazy val instanceTrackerModule: InstanceTrackerModule = {
    ...
    new InstanceTrackerModule(metrics, clock, scallopConf, leadershipModule, instanceRepository, updateSteps)(
  ...
  private[this] lazy val scheduler: MarathonScheduler = {
    ...
    val taskStatusProcessor: TaskStatusUpdateProcessor =
      new TaskStatusUpdateProcessorImpl(metrics, clock, instanceTracker, schedulerDriverHolder, killService, eventBus)
  ...
  flowModule.refillOfferMatcherManagerLaunchTokens(scallopConf, offerMatcherManagerModule.subOfferMatcherManager)
  ...
  val launchQueueModule = new LaunchQueueModule(
    ...
    maybeOfferReviver =
      flowModule.maybeOfferReviver(metrics, clock, scallopConf, eventBus, offersWanted, schedulerDriverHolder),
  ...
  taskJobsModule.handleOverdueTasks(instanceTrackerModule.instanceTracker, killService, metrics)
}
